...
```bash
hexo new post "your-topic"
# → source/_posts/zh/your-topic.md
# Then create the English version at source/_posts/en/your-topic.md
```
...
- **lab-theme** — Custom Anthropic-style theme
